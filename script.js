...
if(startScreenEl) {
    startScreenEl.innerHTML = `
        ...
        <div class="epic-subtitle">THE ULTIMATE REFLEX TEST!</div>
...
window.initGame = async function() {
    ...
    bagZ = 0; score = 0; difficultyMultiplier = 1.0; bagState = "neutral"; isStumbled = false;
...
function checkHit(clientX, clientY) {
    ...
    scaleTarget = 0.6; 
    if (bagState === "attack") {
        score++; uiCoins.innerText = "SCORE: " + score; bagZ -= 13; 
        bagState = "stunned"; stateTimer = Date.now() + 600; bagMat.color.setHex(0xffffff); 
